...
class MedicalCentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical_center" do
    assert_difference('MedicalCenter.count') do
      post medical_centers_url, params: { medical_center: { address: @medical_center.address, description: @medical_center.description, medicalcentertype_id: @medical_center.medicalcentertype_id, name: @medical_center.name, phone_number: @medical_center.phone_number } }
    end
  ...
  test "should update medical_center" do
    patch medical_center_url(@medical_center), params: { medical_center: { address: @medical_center.address, description: @medical_center.description, medicalcentertype_id: @medical_center.medicalcentertype_id, name: @medical_center.name, phone_number: @medical_center.phone_number } }
