...
class GuardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guard" do
    assert_difference('Guard.count') do
      post guards_url, params: { guard: { guard_date: @guard.guard_date, medicalcenter_id: @guard.medicalcenter_id, worker_id: @guard.worker_id } }
    end
  ...
  test "should update guard" do
    patch guard_url(@guard), params: { guard: { guard_date: @guard.guard_date, medicalcenter_id: @guard.medicalcenter_id, worker_id: @guard.worker_id } }
